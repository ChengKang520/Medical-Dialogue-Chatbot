...
def setup_train_args():
    ...
    parser.add_argument('--train_raw_path', default='data/train_med.json', type=str, required=False, help='原始训练语料')
    parser.add_argument('--train_tokenized_path', default='data/train_medCH_tokenized.txt', type=str,
                        required=False,
                        help='将原始训练语料tokenize之后的数据的存放位置')
    parser.add_argument('--valid_raw_path', default='data/validate_med.json', type=str, required=False, help='原始验证语料')
    parser.add_argument('--valid_tokenized_path', default='data/validate_medCH_tokenized.txt', type=str,
                        required=False,
                        help='将原始验证语料tokenize之后的数据的存放位置')
    parser.add_argument('--test_raw_path', default='data/test_med.json', type=str, required=False, help='原始测试语料')
    parser.add_argument('--test_tokenized_path', default='data/test_medCH_tokenized.txt', type=str,
                        required=False,
    ...
    parser.add_argument('--dialogue_model_output_path', default='dialogue_model/', type=str, required=False,
                        help='对话模型输出路径')
    parser.add_argument('--pretrained_model', default='dialogue_model/GPT2_pretrained_ChitChat/', type=str, required=False, help='预训练的GPT2模型的路径')
