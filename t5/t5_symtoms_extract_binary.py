...
class SwagProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        print('******************** Load Train')
        return self._create_examples(os.path.join(data_dir, "test_MedDG_trans.json"), "train")
    ...
    def _create_examples(self, filename, type: str):
        ...
        with open(filename, mode='rb') as json_file:
            ...
            for dialogue_seg_ind in range(len(msg_contents)):
                ...
                if msg_labels[dialogue_seg_ind]== True:
                    msg_labels_temp = 'Yes'
                else:
                    msg_labels_temp = 'No'
...
class MedicalDialogueDataset(Dataset):
    ...
    def _create_features(self, example):
        ...
        tokenized_targets = self.tokenizer.batch_encode_plus(
            [target_], max_length=2, pad_to_max_length=True, return_tensors="pt", truncation=True
        )
